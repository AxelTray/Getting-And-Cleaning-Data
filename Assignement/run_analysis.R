...
temp <- cbind(merged_data_means_std,activity_retreated,subject)

merged_data_means_std_splitted <- split(merged_data_means_std,list(temp$activity,temp$subject))
tidy_data <- lapply(merged_data_means_std_splitted, colMeans)
