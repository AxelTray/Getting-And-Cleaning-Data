...
The function splits is used to split the observations by subject and by activity. Function colMeans is applied to obtain the mean of each variables at a subjectxactivity level.


Finally, the variable **tidy_data** is written into the working directory.
